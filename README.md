...
<li>изучи весь проект - начни с контроллеров airline-project</li>
...
<li>добейся успешного запуска основного сервиса (airline-project) и попробуй обратиться к его контроллерам. <a href="http://localhost:8080/swagger-ui/"> Проверить</a></li>
...
<li>напиши тимлиду(ментору), что успешно выполнил все пункты и готов получить первую задачу</li>
</ol>
...
<li>Front-end</li> - баги, обнаруженные при взаимодействии фронта и бекенда
...
- Изучить используемые на проекте технологии. Достаточно верхнеуровневого понимания - ответить на вопрос "Какую проблему решает эта штука?"
