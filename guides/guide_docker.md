...
Ознакомьтесь с Dockerfile в нашем репозитории, соберите образ основного приложения. Находясь в корне проекта, выполните <code>docker build -f Dockerfile_Project -t airline-project .</code>
